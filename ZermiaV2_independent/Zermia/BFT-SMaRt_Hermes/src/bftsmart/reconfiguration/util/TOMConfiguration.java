...
public class TOMConfiguration extends Configuration {
    ...
    protected void init() {
        ...
        try {
            ...
            if (s == null) {
                requestTimeout = FailureDetector.TOTAL_ORDER_TIMEOUT;
            } else {
            ...
            if (s == null) {
                paxosHighMark = FailureDetector.TOTAL_ORDER_HIGHMARK_COUNT;
            } else {
            ...
            if (s == null) {
                revivalHighMark = FailureDetector.TOTAL_ORDER_HIGHMARK_REVIVAL_TIMEOUT;
            } else {
            ...
            if (s == null) {
                timeoutHighMark = FailureDetector.TOTAL_ORDER_HIGHMARK_TIMEOUT;
            } else {
            ...
            if (s == null) {
                replyVerificationTime = FailureDetector.REPLAY_VERIFICATION_TIME;
            } else {
            ...
            if (s == null) {
                checkpointPeriod = FailureDetector.TOTAL_ORDER_CHECKPOINT_PERIOD;
            } else {
            ...
            if (s == null) {
                globalCheckpointPeriod = FailureDetector.TOTAL_ORDER_GLOBAL_CHECKPOINT_PERIOD;
            } else {
