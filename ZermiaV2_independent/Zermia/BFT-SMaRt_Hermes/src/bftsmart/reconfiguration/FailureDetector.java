...
public class FailureDetector {
    ...
    public static int SHORT_TIMEOUT = 2000;//1000;//2000//3000;        
    public static int TOTAL_ORDER_TIMEOUT = 3000;//2000;//3000//10000;    
    public static int STATE_INIT_TIMEOUT = 3000;//2000;//3000//10000
    public static int CONNECTION_TIMEOUT = 5000;//3000;//3000//10000
