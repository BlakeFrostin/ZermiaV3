...
public class Synchronizer {
    ...
    private void startSynchronization(int nextReg) {
        ...
        if (condition && lcManager.getNextReg() > lcManager.getLastReg()) {
            ...
            //Rolando
            int lastRegency = lcManager.getLastReg();
            ...
            requestsTimer.setTimeout(FailureDetector.recalculateTimeout(lastRegency,nextRegency,requestsTimer.getTimeout()));
            java.util.logging.Logger.getLogger(RequestsTimer.class.getName()).log(Level.SEVERE,"(TOMLayer.evaluateStops) newtimeout="+requestsTimer.getTimeout());
