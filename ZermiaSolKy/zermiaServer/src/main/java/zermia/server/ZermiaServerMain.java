...
//----------------------------------------------------------------------------------//	
	...
	public void populatingAvailableFaults() { //available faults and priority
		...
		faultList1.put(13,"LeakCrash");
		faultList1.put(14,"Crash");
	}	
...
//----------------------------------------------------------------------------------//
    ...
    public void	errorMessage(Integer errorType, Integer repNumber, String fault) {
    	...
    	case 1 : {
    		...
    		System.out.println("**** Available Faults : Crash, Tdelay, Leak, LeakCrash, Dropper, Load, 0Packet, RandPacket, Flood, BigPacket ****"); //acrescentar restantes falhas
