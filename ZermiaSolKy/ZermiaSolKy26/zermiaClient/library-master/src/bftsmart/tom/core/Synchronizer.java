...
public class Synchronizer {
    ...
    public void triggerTimeout(List<TOMMessage> requestList) {
    	//USAR ISTO AQUI E CRIAR UMA NOVA FUNCAO QUE MIMICA ISTO
    ...
    //RICARDOFERNANDEZ, mudar o sync aqui
    private void catch_up(int regency) {
		...
		//TODO: Missing: serialization of the proof?
                ...
                //THIS WAS CHANGED RICARDO FERNANDEZ 
                //original em baixo
                // NÃO É POSSIVEL USAR ESTE ATAQUE VISTO QUE AS REPLICAS VERIFICAO SE O SENDER É IGUAL AO CURRENT LEADER, PORTANTO F
