...
public abstract class TOMSender implements ReplyReceiver, Closeable, AutoCloseable {
	...
	static String rndStr = "Random String";
	byte[] rndByte = rndStr.getBytes();
	...
	//CHECK THIS tirar os ultimos argumento do send
	public void TOMulticast(TOMMessage sm) {
		cs.send(useSignatures, this.viewController.getCurrentViewProcesses(), sm,0,rndByte,"default");
