package zermia.runtime.clients;
...
public class ZermiaClientRuntime {
	public static ZermiaClientRuntime ZermiaClientRuntime = new ZermiaClientRuntime();
	ZermiaRuntimeStub clientStub = new ZermiaRuntimeStub();
...
//----------------------------------------------------------------------------------//	
	...
	public ZermiaClientRuntime() {
	}
	
	public static ZermiaClientRuntime getInstance() {
		return ZermiaClientRuntime;
	}
